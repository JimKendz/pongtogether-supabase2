...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-full px-4 py-4 hidden  md:flex md:flex-col bg-neutral-800 dark:bg-neutral-800 w-[250px] flex-shrink-0",
          className
        )}
        animate={{
  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className="text-neutral-200 dark:text-neutral-200 text-base group-hover/sidebar:translate-x-1 transition duration-150 whitespace-pre inline-block !p-0 !m-0"
      >
        {link.label}
      </motion.span>
    </Link>

...
import { BentoDemo } from "@/components/spieler/Bento"
import { ScrollArea } from "@/components/ui/scroll-area"

export default function Spieler() {
    return (
        <ScrollArea>
            <div className="flex min-h-screen w-full flex-col bg-gray-200 rounded-l-2xl">
                <div className="flex flex-col sm:gap-4 sm:py-10 sm:mx-10">
                    <BentoDemo />
